...
public:
    ...
    RRT(Environment env, double onHowManyStepsDevideAngleDistanceBtw2States, double treasholdToTheGoalDegree) : env(env), onHowManyStepsDevideAngleDistanceBtw2States(onHowManyStepsDevideAngleDistanceBtw2States), treasholdToTheGoalDegree(treasholdToTheGoalDegree){
        std::cout << "RRT has been created" << "\n";
    }
